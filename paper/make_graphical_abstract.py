...
# unique-contribution ribbon
ax.add_patch(FancyBboxPatch((3.2, 0.35), 6.25, 0.72, boxstyle="round,pad=0.05",
                            fc="#fff4e5", ec="#b45309", lw=1.2))
ax.text(6.32, 0.71,
        "First survey to jointly cover multi-tenant security + agentic degradation "
        "and to ship a standardised evaluation protocol",
        ha="center", va="center", fontsize=8.0, color="#7a1010", style="italic")
